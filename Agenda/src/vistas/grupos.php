...
<body>
    ...
    <table>
        ...
        <?php while($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
                ...
                <td>
                    <form method="post" action="../controlador/eliminar_grupo.php">
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                        <button type="submit">Eliminar</button>
                    </form>
                </td>
                <td>
                    <form method="post" action="../controlador/modificar_grupo.php">
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
    ...
    <div class="add-button">
        <button onclick="window.location.href = 'rgrupo.php';">Agregar usuario</button>
    </div>
    <?php
    // Cerrar la conexión
    mysqli_close($conn);
