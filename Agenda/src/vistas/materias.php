...
<body>
    ...
    <table>
        ...
        <?php while($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
                ...
                <td><?php echo $row['nommateria']; ?></td>
                <td>
                    <form method="post" action="../controlador/eliminar_materia.php">
                        <input type="hidden" name="idmateria" value="<?php echo $row['idmateria']; ?>">
                        <button type="submit">Eliminar</button>
                    </form>
                </td>
                <td>
                    <form method="post" action="../controlador/modificar_materia.php">
                        <input type="hidden" name="idmateria" value="<?php echo $row['idmateria']; ?>">
    ...
    <div class="add-button">
        <button onclick="window.location.href = 'rmateria.php';">Agregar materia</button>
    </div>
    <?php
    // Cerrar la conexión
    mysqli_close($conn);
