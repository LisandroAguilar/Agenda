...
<body>
    ...
    <table>
        ...
        <?php while($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
                ...
                <td><?php echo $row['nomprofesor']; ?></td>
                <td>
                    <form method="post" action="../controlador/eliminar_profesor.php">
                        <input type="hidden" name="idprofesor" value="<?php echo $row['idprofesor']; ?>">
                        <button type="submit">Eliminar</button>
                    </form>
                </td>
                <td>
                    <form method="post" action="../controlador/modificar_profesor.php">
                        <input type="hidden" name="idprofesor" value="<?php echo $row['idprofesor']; ?>">
    ...
    <div class="add-button">
        <button onclick="window.location.href = 'rprofesor.php';">Agregar Profesor</button>
    </div>
    <?php
    // Cerrar la conexión
    mysqli_close($conn);
